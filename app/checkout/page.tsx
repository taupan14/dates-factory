...
const CheckoutPage = () => {
  const [dropdownValue, setDropdownValue] = useState("Gopay");
            ...
            <dl className="hidden space-y-6 border-t border-gray-200 pt-6 text-sm font-medium text-gray-900 lg:block">
              ...
              <div className="flex items-center justify-between border-t border-gray-200 pt-6">
                ...
                <dd className="text-base">
                  IDR {total === 0 ? 0 : Math.round(total + total / 5 + 5)}K
                </dd>
              </div>
            </dl>
          </div>
          ...
          <div className="mx-auto max-w-lg lg:max-w-none">
              ...
              <div className="mt-6">
                ...
                <div className="mt-1">
                  <input
                    ...
                    name="name-input"
                    autoComplete="text"
                    className="block w-full rounded-md border-gray-300 shadow-sm focus:border-[#441909] focus:ring-[#441909] sm:text-sm"
                  />
                </div>
              </div>
                ...
                <div className="col-span-3 sm:col-span-4">
                  ...
                  <div className="mt-1">
                    <select
                      ...
                      className="select block w-full rounded-md border-gray-300 shadow-sm focus:border-[#441909] focus:ring-[#441909] sm:text-sm"
                      name="sort"
                    >
                      <option value="Gopay|085162636203|Dates factory">
                        Pay with Gopay
                      </option>
                      <option value="Dana|6285162636203|Dates factory">
                        Pay with Dana
                      </option>
                      <option value="Ovo">Pay with Ovo</option>
                      <option value="ShoppePay">Pay with ShoppePay</option>
                      {/* <option value="Qris">Pay with Qris</option> */}
                    </select>
                  </div>
                </div>
                {/* <div className="col-span-3 sm:col-span-4">
            ...
            <div className="mt-10 border-t border-gray-200 pt-6 ml-0">
              <button
                ...
                style={{ background: "#441909" }}
                className="w-full rounded-md border border-transparent px-20 py-2 text-lg font-medium text-white shadow-sm hover:bg-blue-600 focus:outline-none focus:ring-2 focus:ring-blue-600 focus:ring-offset-2 focus:ring-offset-gray-50 sm:order-last"
              >
                Order Now
              </button>
            </div>
