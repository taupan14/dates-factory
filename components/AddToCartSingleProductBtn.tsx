...
const AddToCartSingleProductBtn = ({
  ...
  return (
    <button
      ...
      className="btn w-[200px] text-lg border border-gray-300 border-1 font-normal bg-white text-[#441909] hover:bg-[#441909] hover:text-white hover:border-[#441909] hover:scale-110 transition-all uppercase ease-in max-[500px]:w-full"
    >
      Add to cart
    </button>
  );
