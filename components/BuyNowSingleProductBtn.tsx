...
const BuyNowSingleProductBtn = ({
  ...
  return (
    <button
      ...
      className="btn w-[200px] text-lg border border-[#441909] hover:border-[#441909] border-1 font-normal bg-[#441909] text-white hover:bg-white hover:scale-110 hover:text-[#441909] transition-all uppercase ease-in max-[500px]:w-full"
    >
      Buy Now
    </button>
  );
