...
const demoPaymentMethods = [
  {
    name: "Pay with Dana",
    code: "Dana",
    account: "085162636203",
    behalf: "Dates Factory",
  },
  {
    name: "Pay with Gopay",
    code: "Gopay",
    account: "6285162636203",
    behalf: "Dates Factory",
  },
  {
    name: "Pay with Ovo",
...
async function insertDemoData() {
  ...
  for (const payment of demoPaymentMethods) {
    await prisma.payment.create({
      data: payment,
    });
  }
  console.log("Demo payment inserted successfully!");
}
